...
**能力**：在支付宝开放平台约定的 PEM 格式下，提供 **公钥模式** 密钥对与 **证书模式** CSR 的本地生成（**`scripts/generate_alipay_rsa2_keys.sh`**，仅需 OpenSSL）、与开放平台控制台及加验签的衔接说明；密钥排错与官方文档见 **`references/reference.md`**。

| 文件 | 说明 |
|------|------|
| `SKILL.md` | 流程、Agent 约束、YAML 描述（触发匹配） |
| `references/reference.md` | 依赖、脚本要点、报错表、文档链接、PEM/安全 |
